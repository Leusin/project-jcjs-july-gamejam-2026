...
##
## 무한히 어려워지지 않는다. 1분쯤에 걸쳐 올라간 뒤로는 밀도를 유지하고,
## 변화는 나방 종류로 준다. 마지막 25초만 살짝 몰아치고 끝난다.
const STAGES := [
	{ "at":   0.0, "beats": [0.0, 2.0],                "travel": 4.5,  "styles": [0] },
	{ "at":  35.0, "beats": [0.0, 2.0, 3.0],           "travel": 4.0,  "styles": [0] },
	{ "at":  75.0, "beats": [0.0, 1.0, 2.0, 3.0],      "travel": 4.0,  "styles": [0, 1] },
	{ "at": 115.0, "beats": [0.0, 1.0, 2.0, 3.0],      "travel": 3.75, "styles": [0, 1, 2] },
	{ "at": 155.0, "beats": [0.0, 1.0, 2.0, 2.5, 3.0], "travel": 3.75, "styles": [0, 1, 2] },
]
