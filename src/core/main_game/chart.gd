...
const STAGES := [
	{ "at": 0.0, "patterns": [[0.0, 2.0], [0.0, 1.0, 2.0], [0.0, 2.0], [0.0, 1.0, 2.0, 3.0]], "travel": 4.5, "styles": [0] },
	{ "at": 20.0, "patterns": [[0.0, 2.0, 3.0], [0.0, 1.0, 2.0], [0.0, 2.0, 2.5, 3.0], [0.0, 1.0, 2.0, 3.0]], "travel": 4.0, "styles": [0] },
	{ "at": 40.0, "patterns": [[0.0, 1.0, 2.0, 3.0], [0.0, 1.5, 2.0, 3.0], [0.0, 0.5, 2.0, 3.0], [0.0, 1.0, 2.0, 2.5, 3.0]], "travel": 4.0, "styles": [0, 1] },
	{ "at": 66.0, "patterns": [[0.0, 2.0, 3.0], [0.0, 1.0, 2.0, 3.0], [0.0, 2.0, 3.0], [0.0, 1.0, 2.0, 3.0]], "travel": 3.75, "styles": [0, 0, 0, 1, 1, 2] },
	{ "at": 90.0, "patterns": [[0.0, 1.0, 2.0, 3.0], [0.0, 0.5, 1.0, 2.0, 3.0], [0.0, 1.0, 2.0, 3.0], [0.0, 1.0, 2.0, 2.5, 3.0]], "travel": 3.5, "styles": [0, 0, 1, 1, 2] },
	{ "at": 112.0, "patterns": [[0.0, 1.0, 2.0, 3.0], [0.0, 0.5, 1.0, 2.0, 3.0], [0.0, 1.0, 2.0, 2.5, 3.0], [0.0, 0.5, 1.0, 2.0, 2.5, 3.0]], "travel": 3.5, "styles": [0, 0, 1, 1, 2] },
]
...
func take_due_notes() -> Array:
	var due: Array = []
	if _conductor == null or _patterns.is_empty():
		return due
	_update_stage()
...
func _apply_stage(index: int) -> void:
	...
	if _conductor != null and _conductor.is_playing:
		...
		_next_pattern_index = 0
		_next_beat_index = 0
	print("구간 %d (%d마디 패턴, 이동 %.2f박)" % [index + 1, _patterns.size(), travel_beats])
