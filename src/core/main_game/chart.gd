...
const STAGES := [
	...
	{ "at":  75.0, "beats": [0.0, 1.0, 2.0, 3.0],      "travel": 3.75, "styles": [0, 0, 0, 1, 1, 2] },
	{ "at": 115.0, "beats": [0.0, 1.0, 2.0, 3.0],      "travel": 3.5,  "styles": [0, 0, 1, 1, 2] },
	{ "at": 155.0, "beats": [0.0, 1.0, 2.0, 2.5, 3.0], "travel": 3.5,  "styles": [0, 0, 1, 1, 2] },
]
